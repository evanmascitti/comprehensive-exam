...
- The water content at the 3000 cm depth (30 m) equals the water content above it between 40 and 50 days. I asked HYDRUS to print information on 10-day intervals, and the water content increases nearly to saturation at this time and depth (see \@ref(fig:every-1-0-days-water-content))
...
Did not have time to address this question.
...
Can't figure out how to change axis limits....I suppose what you are getting at is that the concentration might be continuing to change, even though the graph does not show this at the default scale. 
